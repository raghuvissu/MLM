...
public class CommandWrapperBuilder {
	...
	public CommandWrapperBuilder createCommissionPayment(Long clientId) {
		this.actionName = "CREATE";
		this.entityName = "COMMISSIONPAYMENT";
		this.entityId = clientId;
		this.href = "/commissionpayments/" + clientId;
		return this;
	}
	
	public CommandWrapperBuilder createCommissionWithdraw(Long clientId) {
		this.actionName = "CREATE";
		this.entityName = "COMMISSIONWITHDRAW";
		this.entityId = clientId;
		this.href = "/payments/withdraw/" + clientId;
		return this;
	}
	...
	public CommandWrapperBuilder confirmPayment(final Long paymentId, final String otp) {

		this.actionName = "CONFIRM";
		this.entityName = "PAYMENT";
		this.entityId = paymentId;
		this.supportedEntityType = otp;
		this.href = "/payments/confirmpayment/" + this.entityId;
		return this;
	...
	public CommandWrapperBuilder deleteChannelMapping(Long channelMappingId) {
		this.actionName = "DELETE";
		this.entityName = "CHANNELMAPPING";
		this.entityId = channelMappingId; 
		this.href = "/channelmapping/"+channelMappingId;
	...
	public CommandWrapperBuilder createReferal() {
		this.actionName = "CREATE";
		this.entityName = "REFERAL";
		this.entityId = null;
		this.href = "/referals/template";
		return this;
	}

	public CommandWrapperBuilder updateReferal(final Long referalId) {
		this.actionName = "UPDATE";
		this.entityName = "REFERAL";
		this.entityId = referalId;
		this.href = "/referals/" + referalId;
		return this;
	}
