...
public class CommandWrapper {
	...
	public boolean isCommissionPaymentResource() {
		return this.entityName.equalsIgnoreCase("COMMISSIONPAYMENT");
	}
	
	public boolean isCommissionWithdrawPaymentResource() {
		return this.entityName.equalsIgnoreCase("COMMISSIONWITHDRAW");
	}
