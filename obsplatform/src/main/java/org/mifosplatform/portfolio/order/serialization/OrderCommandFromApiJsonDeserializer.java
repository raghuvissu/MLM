...
public final class OrderCommandFromApiJsonDeserializer {
    ...
    private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("planCode","locale","dateFormat","start_date","paytermCode",
    		...
    		"clientServiceId","nextBillDate","planName","planpoId"));
    private final Set<String> retracksupportedParameters = new HashSet<String>(Arrays.asList("commandName","message","orderId","clientServiceId","type","commandDetails"));
