 ...
 */
package org.mifosplatform.organisation.referal.serialization;
 ...
 */
@Component
public final class ReferalCommandFromApiJsonDeserializer {
    ...
    private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("name", "parentId", "openingDate", "externalId",
            "locale", "dateFormat", "officeType","officeNumber","phoneNumber","email","city","state","country", "actualLevel", "rate", "externalCode", "officeId"));

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public ReferalCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
