...
public interface OfficeWritePlatformService {
	...
	CommandProcessingResult saveOrUpdateOfficeImage(Long officeId, String imageName, InputStream inputStream);

	CommandProcessingResult deleteOfficeImageByName(Long officeId, String fileName);
