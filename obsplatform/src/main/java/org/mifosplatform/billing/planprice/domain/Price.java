...
public class Price extends AbstractPersistable<Long> {
	...
	public Price(final Long planCode, final String chargeCode,final Long productId, final String chargingVariant,
			final BigDecimal price, final Long discountId, Long priceregion,final String contractPeriod,final String currencyId)
	{
	...
	public static Price fromJson(JsonCommand command,
		...
		return new Price(planId, chargeCode, productId,chargevariant, price, discountId,priceregion,duration,currencyId);
	...
	public static Price fromJson(JsonCommand command, Long planId) {
		...
		return new Price(planId, chargeCode, productId,chargevariant, price, discountId,priceregion,duration,currency);
