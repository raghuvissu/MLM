...
JpaSpecificationExecutor<Price>{
	...
	List<Price> findOneByPlanAndService(@Param("planId")Long planId,@Param("productId") Long productId,@Param("duration") String duration,@Param("chargeCode") String chargeCode);
	...
	Price findOneByPlanAndService(@Param("planId")Long planId,@Param("productId") Long productId,@Param("duration") String duration,
