...
public class ConfigurationConstants {
	...
	public static final String CONFIG_REFERAL_LEVEL= "referal_level";
	public static final String CONFIG_REFERAL_MAX_LEVEL= "referal_max_level";
	public static final String CONFIG_COMMISSION_PERCENTAGE= "commission_percentage";
