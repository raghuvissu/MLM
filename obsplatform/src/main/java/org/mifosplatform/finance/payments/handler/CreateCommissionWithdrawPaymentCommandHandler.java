...
@Service
public class CreateCommissionWithdrawPaymentCommandHandler implements NewCommandSourceHandler {

	private final PaymentWritePlatformService writePlatformService;

	@Autowired
	public CreateCommissionWithdrawPaymentCommandHandler(
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		...
		return this.writePlatformService.createReferalWithdrawPayment(command, command.entityId());
	}
