...
public class FinancialTransactionsData {
	...
	public FinancialTransactionsData(Long officeId,Long transactionId, LocalDate transDate,String transactionType, BigDecimal amount,
			...
			String planCode,String description, String clientName, final Long rate, final int status, final String note, final Long clientId, final String officeName) {

		this.officeId = officeId;
		this.transactionId = transactionId;
		this.transDate = transDate;
		if(note != null && note.contains("On Registrantion")){
			this.transactionType = "JOINING AMOUNT";
		}else this.transactionType = transactionType;
		this.amount = amount;
