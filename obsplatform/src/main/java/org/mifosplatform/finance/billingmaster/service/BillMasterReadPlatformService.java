...
public interface BillMasterReadPlatformService {
	...
	Page<FinancialTransactionsData> retrieveSampleData(SearchSqlQuery searchFinancialTransaction, Long clientId,String type, Long officeId);
	
	Page<FinancialTransactionsData> retrieveOtpData(SearchSqlQuery searchFinancialTransaction, String type, String otp, Long officeId);
