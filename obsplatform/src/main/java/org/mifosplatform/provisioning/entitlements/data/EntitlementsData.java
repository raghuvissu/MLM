...
public class EntitlementsData {
	...
	public EntitlementsData(Long id, Long prdetailsId, String requestType,
			...
			String userPassword, String firstName, String lastName, String email, Long officeId, Long taskNo ) {
	...
	public EntitlementsData(Long id, Long prdetailsId, String requestType, String jsonDetails, Long taskNo) {
		this.id = id;
		this.prdetailsId = prdetailsId;
		this.requestType = requestType;
